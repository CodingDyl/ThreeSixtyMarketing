...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 bg-transparent">
      <h1 className="text-2xl md:text-7xl font-bold text-white bg-transparent">
