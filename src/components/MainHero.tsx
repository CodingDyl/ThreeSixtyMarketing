...
export function MainHero() {
  return (
    <div className="min-h-[100vh] rounded-md bg-neutral-900 flex flex-col gap-10 items-center justify-center relative w-full px-[20%]">
        <p className="hidden md:block text-slate-400 text-center leading-6 text-3xl max-w-3xl">
      ...
      <button className="hidden md:block rounded-md text-3xl bg-sky-500 px-6 py-3 hover:-translate-y-2 text-black z-2">Book a Consultation</button>
      <ShootingStars />
      <StarsBackground />
